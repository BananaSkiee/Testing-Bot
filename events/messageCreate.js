...
const autoEmoji = require("../modules/autoEmoji.js");
const joinVoiceCommand = require("../modules/joinvoice.js"); // Tambahkan baris ini
...
module.exports = {
  ...
  async execute(message, client) {
    ...
    await joinVoiceCommand(message); // Tambahkan baris ini
